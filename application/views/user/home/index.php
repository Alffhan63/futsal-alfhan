...
<div class="album py-5 bg-light">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <a href="<?php echo site_url('UserHome/lapangancreate/'.$lap1) ?>">
    ...
    <?php $lap2 = 2; ?>
    <div class="col-md-4">
      <a href="<?php echo site_url('UserHome/lapangancreate/'.$lap2); ?>">
        <div class="card mb-4 box btn btn-sm btn-outline-secondary">
  ...
  <?php $lap3 = 3; ?>
  <div class="col-md-4">
    <a href="<?php echo site_url('UserHome/lapangancreate/'.$lap3); ?>">
      <div class="card mb-4 box btn btn-sm btn-outline-secondary">
...
<?php $lap4 = 4; ?>
<div class="col-md-4">
  <a href="<?php echo site_url('UserHome/lapangancreate/'.$lap4); ?>">
    <div class="card mb-4 box btn btn-sm btn-outline-secondary">
...
<?php $lap5 = 5; ?>
<div class="col-md-4">
  <a href="<?php echo site_url('UserHome/lapangancreate/'.$lap5); ?>">
    <div class="card mb-4 box btn btn-sm btn-outline-secondary">
...
<?php $lap6 = 6; ?>
<div class="col-md-4">
  <a href="<?php echo site_url('UserHome/lapangancreate/'.$lap6); ?>">
    <div class="card mb-4 box btn btn-sm btn-outline-secondary">
